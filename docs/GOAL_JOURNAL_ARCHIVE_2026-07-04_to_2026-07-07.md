> **ARCHIVED 2026-07-10 — every number in this file is void.**
> v1-v31 ran against a corrupted index (uniform cos ~0.75-0.85 squish, fixed by the
> 2026-07-06 reindex). v32-v56 ran against pre-fix ground truth for dcd74148c7ec and
> 85de83ca6323 (both corrected by the owner on 2026-07-09/10). Structural findings may
> still inspire hypotheses but nothing here justifies keeping or rejecting a change.
> The live journal restarts at docs/GOAL_JOURNAL.md with the v57 baseline.
