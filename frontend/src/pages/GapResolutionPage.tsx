  ...
  return (
    <div
      className={`bg-[hsl(var(--card))] rounded-lg p-4 space-y-4 ${
        isResolved ? "border-2 border-green-500/30" : "border-2 border-amber-500/30"
      }`}
    >
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1">
                <p className="text-sm font-medium">
                  {totalGaps} clip{totalGaps !== 1 ? "s" : ""} hit the 75% speed floor
                </p>
                <p className="text-xs text-[hsl(var(--muted-foreground))]">
            ...
            <div>
              {warningCount > 0 && (
                <p className="text-sm text-red-500">
                  ⚠️ {warningCount} clip{warningCount !== 1 ? "s" : ""} will have gaps (skipped)
                </p>
              )}
            </div>
