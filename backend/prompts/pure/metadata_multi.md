...
- The source work is NOT provided to you: NEVER try to guess it or name it, in any field.
- NEVER use character proper names.
...
- `tags`: [TARGET]-language search terms matching the genre of the scene (for example "romance anime", "horror anime") + "anime", "manga".
...
- `tags`: include the [TARGET]-language equivalents of: Anime, Manga, Otaku, Anime Recommendation, Iconic Scene, Best Anime.
...
Full video narration (script): [SCRIPT]
